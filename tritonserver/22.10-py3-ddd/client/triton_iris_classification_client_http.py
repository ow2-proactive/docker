...
def prepare_inference_inputs(input_data: np.ndarray) -> List[httpclient.InferInput]:
    """
...
def prepare_inference_outputs(mode: str) -> List[httpclient.InferRequestedOutput]:
    """
...
def get_output_data(
    results: httpclient.InferResult,
    mode: str
